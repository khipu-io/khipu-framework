...
import static khipu.controller.BesuController.DATABASE_PATH;
...
import khipu.cli.presynctasks.PreSynchronizationTaskRunner;
import khipu.cli.presynctasks.PrivateDatabaseMigrationPreSyncTask;
import khipu.cli.subcommands.PasswordSubCommand;
import khipu.cli.subcommands.PublicKeySubCommand;
import khipu.cli.subcommands.RetestethSubCommand;
import khipu.cli.subcommands.blocks.BlocksSubCommand;
import khipu.cli.subcommands.operator.OperatorSubCommand;
import khipu.cli.subcommands.rlp.RLPSubCommand;
import khipu.controller.BesuController;
import khipu.controller.BesuControllerBuilder;
...
public class BesuCommand implements DefaultCommandValues, Runnable {
  ...
  public BesuController buildController() {
    try {
      return getControllerBuilder().build(protocolContextFactory);
    } catch (final Exception e) {
